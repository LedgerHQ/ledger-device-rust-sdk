...
static cx_err_t cx_unpad(uint8_t *buff, uint32_t pad, size_t block_size, size_t *pad_size);
static cx_err_t cx_pad(uint8_t *buff, size_t len, uint32_t pad, size_t block_size, size_t *pad_size);

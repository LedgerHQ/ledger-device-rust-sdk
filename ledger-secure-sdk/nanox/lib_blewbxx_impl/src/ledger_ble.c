...
void LEDGER_BLE_init(void)
{
	...
	ledger_protocol_data.rx_apdu_buffer            = NULL;
	ledger_protocol_data.rx_apdu_buffer_max_length = 0;
...
void LEDGER_BLE_set_recv_buffer(uint8_t * buffer, uint16_t buffer_length) {
	ledger_protocol_data.rx_apdu_buffer = buffer;
	ledger_protocol_data.rx_apdu_buffer_max_length = buffer_length;
}
...
void LEDGER_BLE_receive(uint8_t * spi_buffer)
{

...
use ledger_device_sdk::tlv_uc::{parse_trusted_name_tlv, TrustedNameOut};
            ...
            Instruction::ParseTlv => {
                ...
                match parse_trusted_name_tlv(&buffer, &mut out) {
                    Ok(()) => {
                        ...
                        ledger_device_sdk::testing::debug_print(out.trusted_name.as_str());
                        ledger_device_sdk::testing::debug_print("\n");
                        ledger_device_sdk::testing::debug_print(out.address.as_str());
                        ledger_device_sdk::testing::debug_print("\n");
                        comm.reply_ok();
                    }
                    Err(err) => {

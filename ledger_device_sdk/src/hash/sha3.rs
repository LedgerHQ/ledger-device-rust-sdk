...
impl HashInit for Keccak256 {
    ...
    fn new() -> Self {
        let mut ctx: Keccak256 = Default::default();
        let _err = unsafe { cx_keccak_init_no_throw(&mut ctx.ctx, 256) };
        ctx
    }
}
...
impl HashInit for Sha3_224 {
    ...
    fn new() -> Self {
        let mut ctx: Sha3_224 = Default::default();
        let _err = unsafe { cx_sha3_init_no_throw(&mut ctx.ctx, 224) };
        ctx
    }
}
...
impl HashInit for Sha3_256 {
    ...
    fn new() -> Self {
        let mut ctx: Sha3_256 = Default::default();
        let _err = unsafe { cx_sha3_init_no_throw(&mut ctx.ctx, 256) };
        ctx
    }
}
...
impl HashInit for Sha3_384 {
    ...
    fn new() -> Self {
        let mut ctx: Sha3_384 = Default::default();
        let _err = unsafe { cx_sha3_init_no_throw(&mut ctx.ctx, 384) };
        ctx
    }
}
...
impl HashInit for Sha3_512 {
    ...
    fn new() -> Self {
        let mut ctx: Sha3_512 = Default::default();
        let _err = unsafe { cx_sha3_init_no_throw(&mut ctx.ctx, 512) };
        ctx
    }
}
...
impl HashInit for Shake128 {
    ...
    fn new() -> Self {
        let mut ctx: Shake128 = Default::default();
        let _err = unsafe { cx_shake128_init_no_throw(&mut ctx.ctx, 128) };
        ctx
    }
}
...
impl HashInit for Shake256 {
    ...
    fn new() -> Self {
        let mut ctx: Shake256 = Default::default();
        let _err = unsafe { cx_shake256_init_no_throw(&mut ctx.ctx, 256) };
        ctx
    }
}
